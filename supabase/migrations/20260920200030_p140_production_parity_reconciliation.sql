...
ALTER TABLE public.patient_intake_responses
  ...
  ADD COLUMN IF NOT EXISTS form_type TEXT DEFAULT 'new_patient',
  ADD COLUMN IF NOT EXISTS form_version TEXT DEFAULT '1.0',
  ...
  ADD COLUMN IF NOT EXISTS service_interest VARCHAR(500),
  ...
  ADD COLUMN IF NOT EXISTS decision_factor VARCHAR(500),
  ADD COLUMN IF NOT EXISTS referral_source VARCHAR(100),
