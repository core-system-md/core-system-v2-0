...
-- tenant_devices already defines created_at in migration 009; there is no registered_at column.
-- Keep the existing created_at value rather than referencing a non-existent legacy timestamp.
