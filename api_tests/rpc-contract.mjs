...
if (!/^https?:\/\//i.test(supabaseUrl)) throw new Error(`[API] Invalid isolated Supabase URL: ${JSON.stringify(supabaseUrl)}`);
if (!anonKey) throw new Error('[API] Missing isolated Supabase anon key after environment normalization.');
