  ...
  public: {
    ...
    Functions: {
      ...
      get_patient_longitudinal: {
        ...
        SetofOptions: {
          from: "*"
          to: "patient_longitudinal_profiles"
          isOneToOne: false
          isSetofReturn: true
        }
      }
      ...
      validate_email_password:
        | {
            Args: { p_email: string; p_password: string; p_tenant_id?: string }
            Returns: {
              created_at: string
              deleted_at: string | null
              email: string
      ...
      verify_pin_hash:
        ...
        | {
            Args: { p_pin: string; p_role: string; p_tenant_id: string }
            Returns: Json
          }
    }
    Enums: {
