          ...
          <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-3">
                ...
                <div><h1 className="text-2xl font-bold text-[#1B2A4A]">الفواتير</h1><p className="mt-1 text-sm text-slate-500">عرض الفواتير عبر جلسة الاستقبال الموثقة، دون وصول مباشر من المتصفح إلى الجداول المالية.</p></div>
              </div>
